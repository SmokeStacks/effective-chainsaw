// Mixed Faction Deck Alternative - References to cardRegistry
...
// Alternative mixed deck configuration
export const mixedDeckTwo: CardReference[] = [
  // Orange entities with different focus
  ...
  // Purple entities with different selection
...
// Aggressive mixed deck
export const aggressiveMixedDeck: CardReference[] = [
  // Focus on aggressive orange cards
  { faction: 'orange', index: 0 },   // TerraBite
  { faction: 'orange', index: 1 },   // GooTooth
  { faction: 'orange', index: 2 },   // MouseByte
  { faction: 'orange', index: 3 },   // VyperDrive
  ...
  // Focus on aggressive purple cards
  { faction: 'purple', index: 0 },   // Dryad
  { faction: 'purple', index: 3 },   // Sovereign
  { faction: 'purple', index: 6 },   // Baroness
  { faction: 'purple', index: 9 },   // Demiurge
