import { Card, Category, EffectType, SkillType, Trigger } from './cards';
...
const binder: Card[] = [
  ...
  },
  {
    ...
    runes: 0,
    plot: 0,
    keywords: 'Rapture 2, Rotten. Aggressive.',
    description: "",
    magi: false,
    phys: false,
    tech: true,
  ...
  },
  {
    ...
    HP: 6,
    timer: 3,
    keywords: "Armored, Covenant, Crusade.",
    abilities: [
      { name: "Armored", amount: 1 },
      { name: "Covenant" },
      { name: "Crusade" },
      { name: "GainAshOnSteal", amount: 3 },
    ],
    description: "Whenever an enemy card is Stolen, gain 3 Ash.",
    magi: false,
    phys: true,
    tech: true,
  },
...
export const cardList: Card[] = binder;
