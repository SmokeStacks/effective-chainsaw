...
const orangeBinder: Card[] = [
  // Tech Entities
  {
    ...
    timer: 2,
    subTypes: ["JAWbreaker"],
    keywords: "Devour. Buffer 2, Scav, Aggro.",
    abilities: [
      { name: "Sabotage", effectType: "wounds", amount: 2 }
    ],
    description: "Sabotage ➔ Inflict 2 Wounds",
    magi: false,
    phys: false,
    tech: true,
  },
  ...
  },
  {
    ...
    HP: 4,
    timer: 3,
    keywords: "Sting 3, Grit.",
    abilities: [
      { name: "ClashDetox" }
    ],
    description: "Clash ➔ Detox.",
    magi: false,
    phys: true,
    tech: false,
  },
  ...
  },
  {
    ...
    HP: 2,
    timer: 3,
    keywords: "Covenant, Duplicate, Dividend, Ambush 2.",
    abilities: [
  ...
  // Phys/Magi Entities
  {
    ...
    abilities: [
      { name: "BitPaymentGainVengeanceAndFreeze", vengeanceAmount: 1, freezeAmount: 1, bitCost: 1 }
    ],
    description: "1 Bit ➔ Gain 1 Vengeance and 1 Freeze.",
    magi: true,
    phys: true,
    tech: false,
  },
  ...
  },
  {
    ...
    HP: 3,
    timer: 2,
    keywords: "Deathless, Override. Buffer 3, Aggro.",
    abilities: [
  ...
  },
  {
    ...
    HP: 5,
    timer: 3,
    keywords: "Solo, Stealth, Grit. Skav, Cursed.",
    abilities: [
  ...
  },
  {
    ...
    ash: 0,
    HP: 4,
    keywords: "Crusade, Grit. Locality.",
    abilities: [
  ...
  // Snips
  {
    ...
    abilities: [
      { name: "PrecognitionSchemeFirstHeadSpaceGainActions", schemeThreshold: 2, actionAmount: 3 }
    ],
  ...
  },
  {
    ...
    abilities: [
      { name: "Dividend" },
      { name: "PandoraAccess", amount: 2 }
    ],
    description: "+2 Pandora Interface.",
    magi: true,
    phys: false,
    tech: true,
  },
  {
    ...
    abilities: [
      ...
      { name: "DataBombSacrificeForFreeze", schemeThreshold: 2, freezeAmount: 5, requiresTarget: true }
    ],
  ...
  },
  {
    ...
    ash: 0,
    scrap: 4,
    keywords: "Dividend 4, Karmic. Impostor.",
    description: "",
    magi: false,
    phys: false,
    tech: true,
  ...
  // Rituals
  {
    ...
    keywords: "",
    abilities: [
      { name: "OnPlayHackHeadSpaceThenFreezeAndOverload", freezeAmount: 3, overloadAmount: 2 }
    ],
  ...
  },
  {
    ...
    keywords: "Vicious 2",
    abilities: [
      { name: "OnPlayGainBitsAndAsh", bitAmount: 5, ashAmount: 5 }
    ],
  ...
  },
  {
    ...
    soul: 0,
    ash: 0,
    keywords: "Duplicate, Surgical. Gravity.",
    abilities: [
      { name: "OnPlayGainBitsIfInterfacedPandora", bitAmount: 7 }
    ],
    description: "If you Interfaced Pandora this turn, +7 bits and place an enemy Adrenochrome IRL. (Note: placing an enemy Adrenochrome is not currently implemented.)",
    magi: true,
    phys: false,
    tech: true,
  },
  {
    ...
    abilities: [
      { name: "MultiThreadingEffect", type: "onPlay" },
      { name: "Duplicate", type: "onPlay", amount: 2 },
      { name: "Vicious", type: "onPlay", amount: 2 },
    ],
    magi: false,
    phys: false,
    tech: true,
  },
  {
    ...
    abilities: [
      { name: "ExploitEffect", type: "onPlay", requiresTarget: true },
    ],
    magi: false,
    phys: false,
    tech: true,
  ...
  // Syms
  {
    ...
    description: "Ascend ➔ Gain 4 Ash, 3 Actions, and 2 Wounds.",
    magi: false,
    phys: true,
    tech: true,
  },
  {
    ...
    runes: 1,
    plot: 3,
    keywords: "Drift, Glitchy.",
    abilities: [
      { name: "CatCafeAscended", amount: 1 }
    ],
    description: "Maintenance ➔ Inflict 1 Lag.",
    magi: false,
    phys: true,
    tech: true,
  },
  ...
  // Landmarks
  {
    ...
    plot: 2,
    keywords: "Grit.",
    description: "Interface, Departed ➔ Inflict 2 Wounds.",
    magi: false,
    phys: true,
    tech: false,
  },
